...
from hyperliquid_liq_taker import HyperliquidLiqTaker
...
async def main():
    ...
    parser.add_argument(
        '-c', '--config',
        type=str,
        default='config_liq_taker.json',
        help='Path to configuration file (default: config_liq_taker.json)'
    )
    ...
    try:
        ...
        market_maker = HyperliquidLiqTaker(args.config)
