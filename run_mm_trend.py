...
from hyperliquid_trend import HyperliquidMMTrend
...
async def main():
    ...
    parser.add_argument(
        '-c', '--config',
        type=str,
        default='config_trend.json',
        help='Path to configuration file (default: config_trend.json)'
    )
    ...
    try:
        ...
        market_maker = HyperliquidMMTrend(args.config)
