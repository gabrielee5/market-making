...
class HyperliquidMMTrend:
    def __init__(self, config_path: str = 'config_trend.json'):
        """
...
async def main():
    # Load configuration
    config_path = os.getenv('CONFIG_PATH', 'config_trend.json')
    
    # Create and start market maker
    market_maker = HyperliquidMMTrend(config_path)
    try:
